...
COMPILE: 	make
CLEAN: 		make clean
INSTALL: 	sudo insmod hello_world_module.ko valueETX=14 nameETX="EmbetronicX" arr_valueETX=100,102,104,106
CHECK:		lsmod | grep <driver_name>
MODIFY:		sudo sh -c "echo 13 > /sys/module/hello_world_module/parameters/cb_valueETX
VERIFY:		dmesg
...
const struct kernel_param_ops my_param_ops = 
{
	...
	.get = &param_get_int,	// .. and standar getter
};
